...
namespace BloodyMaze
{
    ...
    public class LocDataSO : ScriptableObject
    {
        ...
        {
            return locNotesTexts.Find((x) => x.key == key).text[GameController.current.playerProfileSO.playerProfileData.optionsData.language];
        ...
        {
            return locDialogueTexts.Find((x) => x.key == key).dialogue[GameController.current.playerProfileSO.playerProfileData.optionsData.language];
        ...
        {
            return locMessagesText.Find((x) => x.key == key).text[GameController.current.playerProfileSO.playerProfileData.optionsData.language];
